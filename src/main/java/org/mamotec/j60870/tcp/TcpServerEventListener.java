...
public interface TcpServerEventListener extends EventListener {
     ...
     */
    default TcpConnectionEventListener setConnectionEventListenerBeforeStart() {
        return null;
    }

    void connectionIndication(TcpConnection tcpConnection);
